...
"@
    ...
    # Pass in @{ InstallPrerequisites = $true } as a psake parameter to install prerequisites.
    [System.Diagnostics.CodeAnalysis.SuppressMessage('PSUseDeclaredVarsMoreThanAssigments', '')]
    $Prerequisites = 'Pester', 'psake'
}
...
Task BeforeBuild {
    ...
    if ($InstallPrerequisites) {
        ...
        Install-Module -Name $Prerequisites -Repository PSGallery -Force -Verbose -Scope CurrentUser -SkipPublisherCheck
    }
}
